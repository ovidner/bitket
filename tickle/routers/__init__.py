...
from tickle.views import MainEventViewSet, OrganizerViewSet, PersonViewSet, \
    StudentUnionViewSet, CartViewSet, HoldingViewSet, ProductViewSet, \
    ProductVariationViewSet, ProductVariationChoiceViewSet
