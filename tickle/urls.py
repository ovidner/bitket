...
from tickle.views.people import PurchaseView, ShoppingCartView, ShoppingCartDeleteView, add_to_shopping_cart, \
    complete_purchase
...
urlpatterns = patterns(
    ...
    url(r'^shoppingcart/$', ShoppingCartView.as_view(), name='shopping_cart'),
