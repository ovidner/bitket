...
const env = Object.assign({}, {
  ...
  AUTH_FACEBOOK_AUTHORIZATION_URL: process.env.REACT_APP_AUTH_FACEBOOK_AUTHORIZATION_URL,
...
// (new Date).getTime()
const persistedStateTimestampThreshold = 1511828115632

const stripePublicKey = env.STRIPE_PUBLIC_KEY

const typekitId = env.TYPEKIT_ID
